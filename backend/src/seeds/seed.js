...
const admin = await User.create({
  name: process.env.ADMIN_BOOTSTRAP_NAME || "Admin ALHADUNI CARS",
  email: (process.env.ADMIN_BOOTSTRAP_EMAIL || "admin@alhaduni-cars.com").toLowerCase(),
